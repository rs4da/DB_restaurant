...
<div class="d-flex flex-column justify-content-center text-center" style="margin: auto; width: 50%;">
    <button style="padding: 30px; font-size: 50px; font-family: 'Garamond'; margin: 10px; margin-top: 50px;" type="button" class="btn btn-outline-secondary" onclick="location.href='reservations.php'">Reservation</button>
    <button style="padding: 30px; font-size: 50px; font-family: 'Garamond'; margin: 10px;" type="button" class="btn btn-outline-secondary" onclick="location.href='make.php'">Make</button>
</div>