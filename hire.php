  ...
  <body style="background-color: #faf4ff;">
    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark" style="background-color:transparent !important">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="navbar-brand" style="font-color:#ffffff; font-size: 30px;">Hire</a>
                </li>
            </ul>
        </div>  
    </nav>
...
<div class="form-group">
    ...
    <p style="font-size: 35px; margin-top: 25px; font-family: 'Garamond';"><b>Add a employee location:</b></p>
...
<b style="font-size: 35px; margin-top: 25px; font-family: 'Garamond';"><p>Current employee locations:</p></b>
