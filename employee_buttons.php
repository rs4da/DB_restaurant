  ...
  <body style="background-color: #faf4ff;">
    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark" style="background-color:transparent !important">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="navbar-brand" style="font-color:#ffffff; font-size: 30px;">Employee Info</a>
                </li>
            </ul>
        </div>  
    </nav>
...
<div class="d-flex flex-column justify-content-center text-center" style="margin: auto; width: 50%;">
    <button style="padding: 30px; font-size: 50px; font-family: 'Garamond'; margin: 10px; margin-top: 50px;" type="button" class="btn btn-outline-secondary" onclick="location.href='employee.php'">Employee</button>
    <button style="padding: 30px; font-size: 50px; font-family: 'Garamond'; margin: 10px;" type="button" class="btn btn-outline-secondary" onclick="location.href='hire.php'">Hire</button>
</div>